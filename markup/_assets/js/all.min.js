...
!function(e){e.fn.slideAccordion=function(n){var a=e.extend({addClassBeforeAnimation:!1,activeClass:"active",opener:".opener",slider:".slide",animSpeed:300,collapsible:!0,event:"click"},n);return this.each(function(){var n=e(this),t=n.find(":has("+a.slider+")");t.each(function(){var n=e(this),t=n.find(a.opener),l=n.find(a.slider);t.bind(a.event,function(e){if(!l.is(":animated"))if(n.hasClass(a.activeClass))a.collapsible&&l.slideUp(a.animSpeed,function(){s(l),n.removeClass(a.activeClass)});else{var t=n.siblings("."+a.activeClass),d=t.find(a.slider);n.addClass(a.activeClass),i(l).hide().slideDown(a.animSpeed),d.slideUp(a.animSpeed,function(){t.removeClass(a.activeClass),s(d)})}e.preventDefault()}),n.hasClass(a.activeClass)?i(l):s(l)})})};var i=function(e){return e.css({position:"",top:"",left:"",width:""})},s=function(e){return e.show().css({position:"absolute",top:-9999,left:-9999,width:e.width()})}}(jQuery);
...
**************************************************************************
*************************************************************************/
!function(t){var e={init:function(a){return this.each(function(){t(this).data("settings",{element:t(this),handle:".panel_tab",content:".panel_content",opened:!1,hidden:!1,direction:"both",openedSize:250,offset:35,closedSize:0,pos:t(this).position(),animTime:500,startDelta:0,openEvent:"mouseenter",closeEvent:"mouseleave",toggleEvent:"",openSelector:"",closeSelector:"",toggleSelector:""});var n=t(this);t.extend(t(this).data("settings"),a),t(n.data("settings").openSelector).on(n.data("settings").openEvent,function(t){e.open(n)}),t(n.data("settings").closeSelector).on(n.data("settings").closeEvent,function(t){e.close(n,t)}),t(n.data("settings").toggleSelector).on(n.data("settings").toggleEvent,function(t){e.toggle(n)}),1==n.data("settings").opened&&0==n.data("settings").hidden?e.open(n):0==n.data("settings").hidden?e.forceClose(n):1==n.data("settings").hidden&&e.hide(n)})},open:function(e){e.animate({width:e.data("settings").openedSize+"px"},{duration:e.data("settings").animTime,queue:!1}),t(e.data("settings").content).animate({width:e.data("settings").openedSize+"px"},{duration:e.data("settings").animTime,queue:!1}),t(e.data("settings").handle).animate({width:"0px"},{duration:e.data("settings").animTime,queue:!1}),e.data("settings").opened=!0},close:function(e,a){exitMouseX=a.pageX,("both"==e.data("settings").direction||"right"==e.data("settings").direction&&exitMouseX-5<t(e.data("settings").closeSelector).offset().left||"left"==e.data("settings").direction&&exitMouseX+5>t(e.data("settings").closeSelector).offset().left+t(e.data("settings").closeSelector).width())&&(e.animate({width:e.data("settings").offset+"px"},{duration:e.data("settings").animTime,queue:!1}),t(e.data("settings").content).animate({width:"0"},{duration:e.data("settings").animTime,queue:!1}),t(e.data("settings").handle).animate({width:e.data("settings").offset+"px"},{duration:e.data("settings").animTime,queue:!1}),e.data("settings").opened=!1,e.data("settings").hidden=!1)},forceClose:function(e){e.animate({width:e.data("settings").offset+"px"},{duration:e.data("settings").animTime,queue:!1}),t(e.data("settings").content).animate({width:"0"},{duration:e.data("settings").animTime,queue:!1}),t(e.data("settings").handle).animate({width:e.data("settings").offset+"px"},{duration:e.data("settings").animTime,queue:!1}),e.data("settings").opened=!1,e.data("settings").hidden=!1},toggle:function(e){1==e.data("settings").opened?(e.animate({width:e.data("settings").offset+"px"},{duration:e.data("settings").animTime,queue:!1}),t(e.data("settings").content).animate({width:"0"},{duration:e.data("settings").animTime,queue:!1}),t(e.data("settings").handle).animate({width:e.data("settings").offset+"px"},{duration:e.data("settings").animTime,queue:!1}),e.data("settings").opened=!1,e.data("settings").hidden=!1):(e.animate({width:e.data("settings").openedSize+"px"},{duration:e.data("settings").animTime,queue:!1}),t(e.data("settings").content).animate({width:e.data("settings").openedSize+"px"},{duration:e.data("settings").animTime,queue:!1}),t(e.data("settings").handle).animate({width:"0px"},{duration:e.data("settings").animTime,queue:!1}),e.data("settings").opened=!0,e.data("settings").hidden=!1)},hide:function(e){e.animate({width:0},{duration:e.data("settings").animTime,queue:!1}),t(e.data("settings").content).animate({width:"0"},{duration:e.data("settings").animTime,queue:!1}),t(e.data("settings").handle).animate({width:0},{duration:e.data("settings").animTime,queue:!1}),e.data("settings").opened=!1,e.data("settings").hidden=!0},destroy:function(t){}};t.fn.panel=function(a){return e[a]?e[a].apply(this,Array.prototype.slice.call(arguments,1)):"object"!=typeof a&&a?void t.error("Method "+a+" does not exist on jQuery.tooltip"):e.init.apply(this,arguments)}}(jQuery);
...
function initMakeHeaderOpaqueIfHomePage() {
	...
	if ($("body").hasClass('homepage') && $(this).scrollTop() == 0 && !window.matchMedia('only screen and (max-width: 1125px)').matches) {
		...
		console.log("Condition Passed => opacity = 0. width >> ", $(window).width())
		$("header").css("background", "rgba(0,38,60,0)");
	}
	else {
		console.log("Condition FAIL => opacity = 1")
